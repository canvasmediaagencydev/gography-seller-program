...
import { CoinsIcon, GiftIcon, BanknoteIcon, TrendingUpIcon } from 'lucide-react'
      ...
      <div className="container mx-auto px-4 py-6 space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            <TabsList className="grid w-full grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-0 bg-gray-50 border-b border-gray-200 rounded-none p-0">
              <TabsTrigger
                value="overview"
