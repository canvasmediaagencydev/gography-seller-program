...
import { LayoutGrid, PlaneTakeoff, Users, UserCircle, CoinsIcon, Sparkles, Trophy } from 'lucide-react'
...
const MobileBottomNav = memo(function MobileBottomNav({ userProfile: initialUserProfile }: MobileBottomNavProps) {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 mobile-nav">
      ...
      {/* Navigation Items */}
      <div className="relative flex items-center justify-between h-20 pb-safe px-3 overflow-x-auto hide-scrollbar gap-1">
